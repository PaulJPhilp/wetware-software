...
export function notImplementedEffect<A>(
  methodName: string
...
export function createNotionMock(
  overrides: Partial<NotionService>
): NotionService {
  const base: NotionService = {
    ...
    getSourceEntityById: (_pageId) =>
      notImplementedEffect("getSourceEntityById"),
    getSeriesById: (_pageId) => notImplementedEffect("getSeriesById"),
    updateResource: (_pageId, _updates) =>
      notImplementedEffect("updateResource"),
    updateSourceEntity: (_pageId, _updates) =>
      notImplementedEffect("updateSourceEntity"),
