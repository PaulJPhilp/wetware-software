...
describe('Type Guards', () => {
    ...
    describe('isValidMultiSelectProperty', () => {
        ...
        test('rejects invalid multi-select property', () => {
            ...
            expect(isValidMultiSelectProperty({ type: 'multi_select', multi_select: 'not-array' })).toBe(false);
        });
    });
...
describe('validateRequiredProperties', () => {
    ...
    test('throws error for missing required property', () => {
        ...
        expect(() => validateRequiredProperties(properties, requiredProps))
            .toThrow('Missing required property: MissingProperty');
    });
    ...
    test('throws error for wrong property type', () => {
        ...
        expect(() => validateRequiredProperties(properties, requiredProps))
            .toThrow('Invalid property type for Name. Expected: rich_text, Got: title');
    });
});