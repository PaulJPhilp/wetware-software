 ...
 * 
 * This component can be used to test the Featured Series integration
...
export async function IntegrationTest() {
  try {
    console.log('🧪 Testing Featured Series integration...');
    ...
    seriesData.forEach((series, index) => {
      ...
      // Test articles
      series.articles.forEach((article, articleIndex) => {
      ...
      <div className="min-h-screen bg-background">
        <div className="p-4 bg-green-50 border-b border-green-200">
          ...
          <p className="text-sm text-green-700">
            ...
            {seriesData.reduce((total, s) => total + s.articles.length, 0)} total articles
          </p>
        </div>
                ...
                {seriesData.length === 0 && (
                  <div className="p-4 bg-yellow-50 rounded-lg">
                    ...
                    <p className="text-yellow-700 text-sm">
                      No series found. Check that your Notion database has series 
                      with Status = "Active" or "Completed" and published posts.
                    </p>
                  </div>
                )}
              </div>
