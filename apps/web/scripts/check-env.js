...
const hasNotionApiKey = process.env.NOTION_API_KEY || process.env.notion_api_key;
const hasBlogPostsId = process.env.NOTION_DATABASE_ID_BLOG_POSTS || process.env.notion_database_id_blog_posts;
const hasSeriesId = process.env.NOTION_DATABASE_ID_SERIES || process.env.notion_database_id_series;
