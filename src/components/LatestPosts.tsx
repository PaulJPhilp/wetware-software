    ...
    <div className="space-y-4">
        ...
        <div className="flex items-center gap-2 sm:mt-1">
          <div className="inline-flex rounded-md border border-orange overflow-hidden">
            <button
              ...
              className={`flex items-center gap-1 px-2 py-1 text-[9px] ${view === "card" ? "bg-orange text-white" : "text-orange"}`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1 px-2 py-1 text-[9px] ${view === "list" ? "bg-orange text-white" : "text-orange"}`}
            >
      ...
      {view === "card" ? (
        ...
        <div className="flex flex-col rounded-md border border-border overflow-hidden">
          <div className="grid grid-cols-[110px_1fr_90px_1fr_60px] items-center gap-2 px-1 py-0.5 h-6 bg-muted/40 text-[9px] leading-none text-muted-foreground">
            <div>Date</div>
            <div>Title</div>
            <div>Type</div>
            <div>Series</div>
