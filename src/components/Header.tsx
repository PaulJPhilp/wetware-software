    ...
    <header className="sticky top-0 z-50 bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/75 border-b border-border">
      <nav className="max-w-6xl mx-auto px-2 py-1 flex items-center justify-between font-sans min-h-0">
        <div className="flex items-center gap-1">
          ...
          <Link
            href="/"
            className="font-bold text-[11px] hover:text-orange transition-colors leading-none mr-2"
          >
            Wetware & Software
          </Link>
          <span className="text-[9px] text-muted-foreground leading-none ml-1">
        ...
        <div className="flex items-center gap-2 flex-nowrap">
          <Link
            href="/about"
            className="text-[9px] hover:text-orange transition-colors whitespace-nowrap"
          >
            About
          </Link>
          <Link
          ...
          <div className="relative">
            ...
            >
              Content
              <ChevronDown
                className={`w-3 h-3 transition-transform ${isContentOpen ? "rotate-180" : ""}`}
              />
            </button>
            ...
            {isContentOpen && (
              <div className="absolute top-full left-0 mt-1 bg-card border border-border rounded-lg shadow-lg py-2 min-w-[80px] z-10">
                <Link
                  href="/series"
                  className="block px-2 py-1 text-[9px] hover:text-orange hover:bg-muted/50 transition-colors"
